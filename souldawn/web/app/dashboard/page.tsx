...
export default function DashboardPage() {
  ...
  const handleNotify = async (key: "notify_new_drops" | "notify_promos", val: boolean) => {
          ...
          <div className="mt-8 space-y-6">
            ...
            <ScrollReveal delay={200}>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Link href="/collection" className="border border-white/10 bg-surface/50 p-6 hover:border-accent/50 hover:bg-surface transition-colors">
                  <div className="text-3xl mb-3">👕</div>
                  <h3 className="text-sm font-bold">Смотреть каталог</h3>
                  <p className="text-[10px] text-muted mt-1">Все новые товары</p>
                </Link>
                <Link href="/cart" className="border border-white/10 bg-surface/50 p-6 hover:border-accent/50 hover:bg-surface transition-colors">
                  <div className="text-3xl mb-3">🛒</div>
                  <h3 className="text-sm font-bold">Моя корзина</h3>
                  <p className="text-[10px] text-muted mt-1">Оформить покупку</p>
                </Link>
                <a href="https://t.me/souldawn_support_bot" target="_blank" rel="noopener noreferrer" className="border border-white/10 bg-surface/50 p-6 hover:border-accent/50 hover:bg-surface transition-colors">
                  <div className="text-3xl mb-3">💬</div>
            ...
            <div className="mt-8 space-y-6">
              ...
              <div className="border border-white/10 bg-surface/50 p-6">
                ...
                <div className="space-y-4 max-w-md">
                  ...
                  <div>
                    <label className="text-[10px] text-muted font-bold tracking-wider uppercase mb-2 block">Email</label>
                    <input
                      type="email"
                      value={editEmail}
