    ...
    return (
      <div className="pt-28 pb-20 min-h-screen flex flex-col items-center justify-center px-6">
        <div className="flex flex-col items-center animate-fade-in">
          ...
          <h2 className="text-xl font-black tracking-tight uppercase mb-2">Создаём платёж</h2>
          <p className="text-sm text-muted">Переадресация на страницу оплаты YooKassa...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-3xl mx-auto">
        <ScrollReveal>
          <div>
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tight uppercase">Оформление</h1>
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <ScrollReveal delay={400}>
              <div className="sticky top-28 border border-white/5 bg-surface/50 p-6">
