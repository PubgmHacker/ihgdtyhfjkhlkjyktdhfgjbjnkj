...
export default function ProductModal({ product, onClose }: ProductModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8">
      {/* Backdrop */}
      <div
        className="absolute inset-0 bg-bg/80 backdrop-blur-md animate-fade-in"
        onClick={onClose}
      />

      {/* Modal card */}
      <div className="relative w-full max-w-4xl max-h-[90vh] bg-surface border border-white/[0.06] overflow-y-auto animate-fade-in-up">
        {/* Close button */}
        <button
          onClick={onClose}
